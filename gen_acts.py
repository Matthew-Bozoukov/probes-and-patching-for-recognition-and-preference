...
model_name = "meta-llama/Llama-2-70b-chat-hf"#change this for whichever model you want
api_key = "x"
run_id = 1369
...
prompt_modes = ["self-recognition"]
prompt_modes_inference = ["self-recognition"] #should be a subset of prompt_modes
